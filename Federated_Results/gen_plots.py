...
def plot_dataframes(dataframe_dict, metrics, marker_frequency=20, y_limit=(0.0, 1.0), y_tick_interval=0.05):
    """
    ...
    ax.set_title('Federated Training Accuracy vs. Validation Accuracy on CIFAR10', fontsize=14)
...
def main(**kwargs):
    ...
    plot = plot_dataframes(summaries, metrics_to_plot)
