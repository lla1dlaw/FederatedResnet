...
import torchvision
import math
__all__ = ['cifar10STOCH_quantizedoctav']
...
class QuantizedNet(nn.Module):
    def __init__(self):
        ...
        self.layer_bitwidths = {'conv1': 4, 'conv2': 4, 'fc1': 4, 'fc2': 4}
        self.scale_factors = {}
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 3, 32, 32)  # Change 1 to 3 for RGB images
...
def cifar10STOCH_quantizedoctav(**model_config):
